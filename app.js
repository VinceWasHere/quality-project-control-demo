...
async function filesToAttachments(fileLists){
  const files=fileLists.flatMap(x=>[...x]),total=files.reduce((a,f)=>a+f.size,0);if(total>MAX_TOTAL_ATTACHMENT_BYTES)toast('El total de adjuntos excede los 12 MB permitidos en esta demo estática.');
